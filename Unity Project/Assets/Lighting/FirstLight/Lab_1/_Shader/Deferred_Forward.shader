...
Shader "Tut/Lighting/FirstLight/Lab_1/Deferred_Forward" {
	Properties{
		...
		_dilateVertex("dialte amount of Object",range(1,3)) = 1
		_dilateForward("dialte amount of Object",range(1,3)) = 1.2
		_dilateDeferred("dialte amount of Object",range(1,3)) = 1.4
	}
	SubShader {
		//.1
		pass{
